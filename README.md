[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/Sodra/SP-MangaEditor)
...
# Sodra's attempt to fix Manga Editor Desu.
This fork exists to clean things up, and make the UX cleaner and quicker.
